...
composición (ADR-T11) y por clientes externos. [T20](./ADR-T20-versionado-de-contratos.md) versiona los
...
5. **Endpoints operativos sin versión**: `/health`, `/openapi` y Scalar no se versionan; no son
   contrato de negocio.
6. **Regla de evolución**, alineada con [T20](./ADR-T20-versionado-de-contratos.md): dentro de una versión
...
[T11](./ADR-T11-composicion-de-api.md) · [T14](./ADR-T14-gateway-yarp.md) · [T20](./ADR-T20-versionado-de-contratos.md) · [T21](./ADR-T21-estrategia-de-pruebas.md)
