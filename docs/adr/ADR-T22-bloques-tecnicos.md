# ADR-T22 — Building blocks técnicos compartidos
...
- **Una librería común que incluya dominio**: prohibido por el Strategic Design.
...
Curso 1 y 2: buenas prácticas, evitar duplicación de lógica y acoplamiento fuerte.

## Decisiones relacionadas
[T02](./ADR-T02-monorepo.md) · [T03](./ADR-T03-arquitectura-limpia.md) · [T20](./ADR-T20-versionado-de-contratos.md)
