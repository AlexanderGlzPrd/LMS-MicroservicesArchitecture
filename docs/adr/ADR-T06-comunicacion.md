# ADR-T06 — Comunicación síncrona y asíncrona
...
- **Todo síncrono**: consistencia inmediata, pero acopla la disponibilidad del Core a otros servicios
  y no ejercita EDA.
...
Curso 2: proceso distribuido, EDA, consistencia eventual. Curso 1: resiliencia y diseño de APIs.

## Decisiones relacionadas
[T07](./ADR-T07-rabbitmq-masstransit.md) · [T12](./ADR-T12-conjunto-de-lecciones-vigente.md) · [T13](./ADR-T13-saga-matricula-de-pago.md) · [T19](./ADR-T19-resiliencia.md)
