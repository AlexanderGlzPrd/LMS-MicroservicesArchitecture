...
reconocer el acceso concedido**, y [T06](./ADR-T06-comunicacion.md) asigna ese hecho al Integration
...
[T08](./ADR-T08-outbox-transaccional.md) no estaba implementado y `learning` no tenía **ninguna**
...
`404 CourseProgressNotFound`. [T24](./ADR-T24-versionado-de-api-rest.md) §6 prohíbe exactamente eso
...
Se autoriza para ello una **excepción única, nominal y acotada** a [T24](./ADR-T24-versionado-de-api-rest.md) §6:
...
- **No existe ningún consumidor desplegado** del contrato de `learning`: no hay Gateway
  ([T14](./ADR-T14-gateway-yarp.md)), ni BFF ([T11](./ADR-T11-composicion-de-api.md)), ni cliente
...
[T24](./ADR-T24-versionado-de-api-rest.md)**, y quien pretenda una excepción necesita **su propio ADR**,
con sus propios hechos, sin poder apoyarse en este. Registrar la decisión aquí —y no en las notas de
un cambio concreto— es precisamente lo que impide que se convierta en precedente tácito.
...
[T06](./ADR-T06-comunicacion.md) · [T08](./ADR-T08-outbox-transaccional.md) · [T09](./ADR-T09-inbox-deduplicacion.md) · [T12](./ADR-T12-conjunto-de-lecciones-vigente.md) · [T20](./ADR-T20-versionado-de-contratos.md) · [T24](./ADR-T24-versionado-de-api-rest.md)
