...
[T15](./ADR-T15-seguridad-keycloak.md) y `arquitectura-de-seguridad.md` §5 designan al propietario de ese
...
cada servicio y Gateway ([T14](./ADR-T14-gateway-yarp.md)) llegan después. Mientras tanto, los tres
...
- **Transportar `StudentName` dentro de `CursoFinalizado`**: [T15](./ADR-T15-seguridad-keycloak.md) ya
...
8. **[T15](./ADR-T15-seguridad-keycloak.md) sigue vigente e íntegro.** Keycloak sigue siendo el
...
## Justificación
La exigencia de `contextos-delimitados.md` §5 y la disponibilidad de Keycloak pertenecen a incrementos
...
[T03](./ADR-T03-arquitectura-limpia.md) promete y casi nunca se comprueba.
...
[T03](./ADR-T03-arquitectura-limpia.md) · [T06](./ADR-T06-comunicacion.md) · [T09](./ADR-T09-inbox-deduplicacion.md) · [T14](./ADR-T14-gateway-yarp.md) · [T15](./ADR-T15-seguridad-keycloak.md) · [T19](./ADR-T19-resiliencia.md)
