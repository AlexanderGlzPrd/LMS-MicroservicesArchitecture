# ADR-T12 — Conjunto actual de LessonIds en Learning
...
- Buena evidencia de resiliencia (Circuit Breaker y fail-safe visibles).
...
Curso 1: resiliencia, timeouts, Circuit Breaker. Curso 2: consistencia y protección del Core.

## Decisiones relacionadas
[T06](./ADR-T06-comunicacion.md) · [T10](./ADR-T10-cqrs-en-learning.md) · [T19](./ADR-T19-resiliencia.md)
