...
- **Fecha:** 2026-07-13
- **Estado:** Aceptado
- **Etapa:** DDD Estratégico — Paso 2 (Subdominios)
- **Decisión asociada:** [ADR-0003](./adr/0003-clasificacion-subdominios.md)
...
| Pagos *(futuro, Etapa 2)* | Precio, Cobro, Reembolso, Cupón |
...
| **Matriculación** | Puerta de entrada al valor; ganará peso con los pagos (Etapa 2). |
...
| **Orquestación de pagos** *(Etapa 2)* | La coordinación (precios, cupones, reembolsos, SAGA) es lógica de negocio propia. |

### Generic Domains
| Subdominio | Justificación |
|---|---|
| **Autenticación** | Problema resuelto en todas partes → se compra/adopta (**Keycloak**, Etapa 3). |
| **Procesamiento de pagos** *(Etapa 2)* | Cobrar es un problema resuelto → proveedor externo (Stripe/etc.). |
