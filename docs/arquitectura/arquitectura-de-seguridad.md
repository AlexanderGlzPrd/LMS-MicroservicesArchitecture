...
- Decisiones: [ADR-T14](../adr/ADR-T14-gateway-yarp.md) · [ADR-T15](../adr/ADR-T15-seguridad-keycloak.md) · [ADR-T23](../adr/ADR-T23-comando-matricula-de-pago.md)
...
## 6. Seguridad de la Saga (extensión opcional)
