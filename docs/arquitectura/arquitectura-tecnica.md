...
- **Kubernetes:** un StatefulSet + PVC por servicio (aislamiento más fuerte).
...
> Desplegar bases de datos y broker **dentro del clúster** es una decisión **de entorno local**, no
