...
## 2. Alcance: MVP funcional vs. extensión opcional
...
| **Extensión opcional** | paid-enrollment · payment-provider-sim | **compra de acceso**, existe para demostrar una **Saga con compensaciones** |
...
> Enrollment (ver [ADR-T23](../adr/ADR-T23-comando-matricula-de-pago.md)).
...
| `paid-enrollment` | opcional | orquestador de la Saga de compra (estado persistido) |
| `payment-provider-sim` | opcional | proveedor de pago simulado (autorizar/capturar/anular/reembolsar) |
...
Detalle completo en [matriz-de-comunicacion.md](./matriz-de-comunicacion.md).
...
- [Bounded Contexts](./contextos-delimitados.md) · [Flujos de aplicación](./flujos-de-aplicacion.md)
- [Arquitectura técnica](./arquitectura-tecnica.md) · [Matriz de comunicación](./matriz-de-comunicacion.md)
- [Fiabilidad e idempotencia](./fiabilidad-e-idempotencia.md) · [Seguridad](./arquitectura-de-seguridad.md)
