...
- **Fecha:** 2026-07-16 · **Estado:** congelado · Decisión: [ADR-T06](../adr/ADR-T06-comunicacion.md)
...
> conoce Learning. Aclaración de redacción alineada con [ADR-T11](../adr/ADR-T11-composicion-de-api.md);
