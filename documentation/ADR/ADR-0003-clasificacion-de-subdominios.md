...
- **Estado:** Aceptado
- **Fecha:** 2026-07-13
- **Documento asociado:** [subdominios.md](../DDD/subdominios.md)
...
- **Clasificación revisada:** un único Core; Certificación como Supporting;
...
La clasificación inicial confundía **criticidad estratégica** con **madurez del MVP** y ampliaba el
Core más allá de lo que el negocio sostiene.
...
(un Core simple sigue siendo Core). El criterio aplicado es directo: *si un competidor hiciera esto
mucho mejor, ¿mataría el negocio?*. Separar auth/authz y proceso/orquestación evita meter reglas
