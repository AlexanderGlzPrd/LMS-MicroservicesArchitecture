# ADR-0022 — Políticas de resiliencia
...
- Cada modo de fallo tiene una señal observable: Circuit Breaker abierto, mensaje en cola de mensajes
  muertos, respuesta degradada.
...
[ADR-0009](./ADR-0009-comunicacion-sincrona-y-asincrona.md) · [ADR-0012](./ADR-0012-inbox-y-deduplicacion.md) · [ADR-0014](./ADR-0014-composicion-de-api-en-bff.md) · [ADR-0015](./ADR-0015-conjunto-vigente-de-lecciones.md) · [ADR-0016](./ADR-0016-saga-de-compra-de-acceso.md)
